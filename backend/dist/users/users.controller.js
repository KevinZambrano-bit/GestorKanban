...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Perfil del usuario actual' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, global_role_decorator_1.RequireGlobalRole)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Buscar usuario por ID' }),
...
exports.UsersController = UsersController = __decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, global_role_guard_1.GlobalRoleGuard),
